...
//	
		...
		memberservice.save(new Member("Juan", "Lopez Hidalgo", "48194415P", "juanlopi@gmail.com", "Calle Betis nº3", "+342435653", "ES0431351875865760908446", "https://uifaces.co/our-content/donated/ukegoVAy.jpg","true", LocalDate.of(2020, 04,01), LocalDate.of(1990, 04, 02) ));
		memberservice.save(new Member("Maria", "Garcia Galan", "51153428W", "mariagarga@gmail.com", "Calle Albert Einstein nº1", "+345465432", "ES7531572901742774659264", "https://uifaces.co/our-content/donated/UZ0VIIh3.png","false", LocalDate.of(2020, 04,01), LocalDate.of(1997, 04, 02) ));
		...
		Product p2 = new Product("Legend of the Five Rings", "Alderac Entertainment Group", "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcRaMAnCTdA1KtA9lvJRioTybLoFXwtm5YtzEG2Ule5ZvBXj9V7G", 25.38, 7, 50);
		Product p3 = new Product("Trauma Unit", "Nosolorol", "https://www.nosolorol.com/1174-thickbox_default/trauma-unit.jpg", 39.99, 5, 50);
		Product p4 = new Product("Anima: Beyond Fantasy", "Fantasy Flight Games", "https://imgv2-2-f.scribdassets.com/img/document/212961752/original/82591b85f6/1616070278?v=1", 45.32, 6, 50 );
		Product p5 = new Product("7th Sea: The New World", "Alderac Entertainment Group", "https://images-na.ssl-images-amazon.com/images/I/51erMHQUglL.jpg", 75.42, 7, 50);
		Product p6 = new Product("FATE", "Evil Hat Productions", "https://m.media-amazon.com/images/S/aplus-media/vc/6bf6f621-14b5-4e25-bedb-56181576936d.__CR0,0,300,300_PT0_SX300_V1___.jpg", 41.80, 7, 50);
		Product p7 = new Product("Pathfinder", "Paizo Publishing", "https://images-na.ssl-images-amazon.com/images/I/816ww2JzYiL.jpg", 60.25, 5, 50);
		Product p8 = new Product("The Call of Cthulhu", "Chaosium", "https://images-na.ssl-images-amazon.com/images/I/91uc2GcyEeL.jpg", 45.30, 4, 50);		
...
//		);
		...
		Game g2 = new Game(LocalDateTime.of(LocalDate.of(2021, 8, 10), LocalTime.of(14, 00)), p1);
		gameservice.save(g1);
		gameservice.save(g2);
